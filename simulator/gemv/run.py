...
parser.add_argument('--name', required=True, help="the test compile output dir")
parser.add_argument('--cmaddr', help="IP:port for CS system")
parser.add_argument('--inputs', help="optional .npz file containing A, x, and b arrays")
parser.add_argument('--y-out', help="optional .npy file for saving the Cerebras result")
